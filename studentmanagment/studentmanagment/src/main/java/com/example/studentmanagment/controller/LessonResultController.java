...
import com.example.studentmanagment.service.LessonResultService;
import org.springframework.security.access.prepost.PreAuthorize;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping("/api/lesson-results")
public class LessonResultController {
    private final LessonResultService lessonResultService;
    public LessonResultController(LessonResultService lessonResultService) { this.lessonResultService = lessonResultService; }
